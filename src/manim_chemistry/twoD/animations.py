...
class GMAnimationBuilder:
    def __init__(self, molecule: GraphMolecule, atoms: VGroup|None = None, bonds: VGroup|None = None):
    ...
    def rotate_atoms_about_bond(self, atom_a, atom_b, angle=PI/4):
        ...
        return [atom.animate.move_to(atom_copy) for atom, atom_copy in zip(self.atoms, self.atoms_copy)]
