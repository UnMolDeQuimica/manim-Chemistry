...
from ..manim_chemistry_molecule import MCAtom, MCBond, MCElement, MCMolecule
...
class NewGraphMolecule(Graph):
    ...
    def build_from_mol(self, mol_file, label=False, language="ENG", *args, **kwargs):
        ...
        return NewGraphMolecule(vertices, edges, label, *args, **kwargs)
