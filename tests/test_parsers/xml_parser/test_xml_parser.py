...
from manim_chemistry.utils import XMLParser
from .xml_parser_fixtures import BaseTestXMLParser
...
class TestXMLParser(BaseTestXMLParser):
    ...
    def test_parse_files(
        ...
        self.compare_read_molecule_and_known_values(
            XMLParser(self.acetone_2d).molecule_data, acetone_2d_molecule_data
        )

        # Test parse 3D acetone file
        self.compare_read_molecule_and_known_values(
            XMLParser(self.acetone_3d).molecule_data,
            acetone_3d_molecule_data,
        )
        ...
        self.compare_read_molecule_and_known_values(
            XMLParser(self.morphine_3d).molecule_data,
            morphine_3d_molecule_data,
        )
        ...
        self.compare_read_molecule_and_known_values(
            XMLParser(self.heme_3d).molecule_data,
            heme_3d_molecule_data,
        )
