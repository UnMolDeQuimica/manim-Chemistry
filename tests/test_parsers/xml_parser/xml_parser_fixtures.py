...
"""
    ...
    def acetone_2d_molecule_data(self):
        return ({1: {'element': 'O', 'coords': np.array([3.732, 0.75 , 0.   ])}, 2: {'element': 'C', 'coords': np.array([2.866, 0.25 , 0.   ])}, 3: {'element': 'C', 'coords': np.array([2.  , 0.75, 0.  ])}, 4: {'element': 'C', 'coords': np.array([ 2.866, -0.75 ,  0.   ])}, 5: {'element': 'H', 'coords': np.array([2.31  , 1.2869, 0.    ])}, 6: {'element': 'H', 'coords': np.array([1.4631, 1.06  , 0.    ])}, 7: {'element': 'H', 'coords': np.array([1.69  , 0.2131, 0.    ])}, 8: {'element': 'H', 'coords': np.array([ 2.246, -0.75 ,  0.   ])}, 9: {'element': 'H', 'coords': np.array([ 2.866, -1.37 ,  0.   ])}, 10: {'element': 'H', 'coords': np.array([ 3.486, -0.75 ,  0.   ])}}, {0: {'from_atom_index': 1, 'to_atom_index': 2, 'bond_type': 2}, 1: {'from_atom_index': 2, 'to_atom_index': 3, 'bond_type': 1}, 2: {'from_atom_index': 2, 'to_atom_index': 4, 'bond_type': 1}, 3: {'from_atom_index': 3, 'to_atom_index': 5, 'bond_type': 1}, 4: {'from_atom_index': 3, 'to_atom_index': 6, 'bond_type': 1}, 5: {'from_atom_index': 3, 'to_atom_index': 7, 'bond_type': 1}, 6: {'from_atom_index': 4, 'to_atom_index': 8, 'bond_type': 1}, 7: {'from_atom_index': 4, 'to_atom_index': 9, 'bond_type': 1}, 8: {'from_atom_index': 4, 'to_atom_index': 10, 'bond_type': 1}})

    @pytest.fixture
    def acetone_3d_molecule_data(self):
        return ({1: {'element': 'O', 'coords': np.array([ 3.0000e-04, -1.3171e+00, -2.0000e-04])}, 2: {'element': 'C', 'coords': np.array([ 0.    , -0.0872,  0.0006])}, 3: {'element': 'C', 'coords': np.array([ 1.281e+00,  7.024e-01, -2.000e-04])}, 4: {'element': 'C', 'coords': np.array([-1.2813e+00,  7.0190e-01, -2.0000e-04])}, 5: {'element': 'H', 'coords': np.array([ 1.3279,  1.3235, -0.898 ])}, 6: {'element': 'H', 'coords': np.array([1.326 , 1.3282, 0.8945])}, 7: {'element': 'H', 'coords': np.array([2.1351, 0.0196, 0.0027])}, 8: {'element': 'H', 'coords': np.array([-2.1352,  0.0187,  0.0027])}, 9: {'element': 'H', 'coords': np.array([-1.3284,  1.323 , -0.898 ])}, 10: {'element': 'H', 'coords': np.array([-1.3266,  1.3278,  0.8945])}}, {0: {'from_atom_index': 1, 'to_atom_index': 2, 'bond_type': 2}, 1: {'from_atom_index': 2, 'to_atom_index': 3, 'bond_type': 1}, 2: {'from_atom_index': 2, 'to_atom_index': 4, 'bond_type': 1}, 3: {'from_atom_index': 3, 'to_atom_index': 5, 'bond_type': 1}, 4: {'from_atom_index': 3, 'to_atom_index': 6, 'bond_type': 1}, 5: {'from_atom_index': 3, 'to_atom_index': 7, 'bond_type': 1}, 6: {'from_atom_index': 4, 'to_atom_index': 8, 'bond_type': 1}, 7: {'from_atom_index': 4, 'to_atom_index': 9, 'bond_type': 1}, 8: {'from_atom_index': 4, 'to_atom_index': 10, 'bond_type': 1}})

    @pytest.fixture
    def morphine_2d_molecule_data(self):
        return ({1: {'element': 'O', 'coords': np.array([2.2314, 0.0528, 0.    ])}, 2: {'element': 'O', 'coords': np.array([ 2.    , -2.4021,  0.    ])}, 3: {'element': 'O', 'coords': np.array([2.    , 2.4021, 0.    ])}, 4: {'element': 'N', 'coords': np.array([ 6.1607, -0.9511,  0.    ])}, 5: {'element': 'C', 'coords': np.array([ 3.6897, -0.4755,  0.    ])}, 6: {'element': 'C', 'coords': np.array([ 4.5133, -0.9511,  0.    ])}, 7: {'element': 'C', 'coords': np.array([ 5.337 , -0.4755,  0.    ])}, 8: {'element': 'C', 'coords': np.array([ 2.866 , -0.9511,  0.    ])}, 9: {'element': 'C', 'coords': np.array([4.2392, 0.2219, 0.    ])}, 10: {'element': 'C', 'coords': np.array([3.6897, 0.4755, 0.    ])}, 11: {'element': 'C', 'coords': np.array([5.337 , 0.4755, 0.    ])}, 12: {'element': 'C', 'coords': np.array([5.5918, 0.2219, 0.    ])}, 13: {'element': 'C', 'coords': np.array([4.5133, 0.9511, 0.    ])}, 14: {'element': 'C', 'coords': np.array([ 2.866 , -1.9022,  0.    ])}, 15: {'element': 'C', 'coords': np.array([ 4.5133, -1.9022,  0.    ])}, 16: {'element': 'C', 'coords': np.array([2.866 , 0.9511, 0.    ])}, 17: {'element': 'C', 'coords': np.array([ 3.6897, -2.3777,  0.    ])}, 18: {'element': 'C', 'coords': np.array([ 6.8418, -1.6832,  0.    ])}, 19: {'element': 'C', 'coords': np.array([4.5133, 1.9022, 0.    ])}, 20: {'element': 'C', 'coords': np.array([2.866 , 1.9022, 0.    ])}, 21: {'element': 'C', 'coords': np.array([3.6897, 2.3777, 0.    ])}, 22: {'element': 'H', 'coords': np.array([ 5.0597, -1.6022,  0.    ])}, 23: {'element': 'H', 'coords': np.array([ 5.6284, -1.274 ,  0.    ])}, 24: {'element': 'H', 'coords': np.array([ 2.0496, -1.1875,  0.    ])}, 25: {'element': 'H', 'coords': np.array([4.376 , 0.8266, 0.    ])}, 26: {'element': 'H', 'coords': np.array([3.6795, 0.4887, 0.    ])}, 27: {'element': 'H', 'coords': np.array([5.9476, 0.3679, 0.    ])}, 28: {'element': 'H', 'coords': np.array([5.549 , 1.0581, 0.    ])}, 29: {'element': 'H', 'coords': np.array([6.184 , 0.4057, 0.    ])}, 30: {'element': 'H', 'coords': np.array([5.4989, 0.8349, 0.    ])}, 31: {'element': 'H', 'coords': np.array([ 2.866 , -2.5222,  0.    ])}, 32: {'element': 'H', 'coords': np.array([ 5.0503, -2.2122,  0.    ])}, 33: {'element': 'H', 'coords': np.array([ 3.6897, -2.9977,  0.    ])}, 34: {'element': 'H', 'coords': np.array([ 6.3879, -2.1055,  0.    ])}, 35: {'element': 'H', 'coords': np.array([ 7.2641, -2.1371,  0.    ])}, 36: {'element': 'H', 'coords': np.array([ 7.2957, -1.2609,  0.    ])}, 37: {'element': 'H', 'coords': np.array([5.0503, 2.2122, 0.    ])}, 38: {'element': 'H', 'coords': np.array([3.6897, 2.9977, 0.    ])}, 39: {'element': 'H', 'coords': np.array([ 2.    , -3.0222,  0.    ])}, 40: {'element': 'H', 'coords': np.array([2.    , 3.0222, 0.    ])}}, {0: {'from_atom_index': 1, 'to_atom_index': 8, 'bond_type': 1}, 1: {'from_atom_index': 1, 'to_atom_index': 16, 'bond_type': 1}, 2: {'from_atom_index': 2, 'to_atom_index': 14, 'bond_type': 1}, 3: {'from_atom_index': 2, 'to_atom_index': 39, 'bond_type': 1}, 4: {'from_atom_index': 3, 'to_atom_index': 20, 'bond_type': 1}, 5: {'from_atom_index': 3, 'to_atom_index': 40, 'bond_type': 1}, 6: {'from_atom_index': 4, 'to_atom_index': 7, 'bond_type': 1}, 7: {'from_atom_index': 4, 'to_atom_index': 12, 'bond_type': 1}, 8: {'from_atom_index': 4, 'to_atom_index': 18, 'bond_type': 1}, 9: {'from_atom_index': 5, 'to_atom_index': 6, 'bond_type': 1}, 10: {'from_atom_index': 5, 'to_atom_index': 8, 'bond_type': 1}, 11: {'from_atom_index': 5, 'to_atom_index': 9, 'bond_type': 1}, 12: {'from_atom_index': 5, 'to_atom_index': 10, 'bond_type': 1}, 13: {'from_atom_index': 6, 'to_atom_index': 7, 'bond_type': 1}, 14: {'from_atom_index': 6, 'to_atom_index': 15, 'bond_type': 1}, 15: {'from_atom_index': 6, 'to_atom_index': 22, 'bond_type': 1}, 16: {'from_atom_index': 7, 'to_atom_index': 11, 'bond_type': 1}, 17: {'from_atom_index': 7, 'to_atom_index': 23, 'bond_type': 1}, 18: {'from_atom_index': 8, 'to_atom_index': 14, 'bond_type': 1}, 19: {'from_atom_index': 8, 'to_atom_index': 24, 'bond_type': 1}, 20: {'from_atom_index': 9, 'to_atom_index': 12, 'bond_type': 1}, 21: {'from_atom_index': 9, 'to_atom_index': 25, 'bond_type': 1}, 22: {'from_atom_index': 9, 'to_atom_index': 26, 'bond_type': 1}, 23: {'from_atom_index': 10, 'to_atom_index': 13, 'bond_type': 2}, 24: {'from_atom_index': 10, 'to_atom_index': 16, 'bond_type': 1}, 25: {'from_atom_index': 11, 'to_atom_index': 13, 'bond_type': 1}, 26: {'from_atom_index': 11, 'to_atom_index': 27, 'bond_type': 1}, 27: {'from_atom_index': 11, 'to_atom_index': 28, 'bond_type': 1}, 28: {'from_atom_index': 12, 'to_atom_index': 29, 'bond_type': 1}, 29: {'from_atom_index': 12, 'to_atom_index': 30, 'bond_type': 1}, 30: {'from_atom_index': 13, 'to_atom_index': 19, 'bond_type': 1}, 31: {'from_atom_index': 14, 'to_atom_index': 17, 'bond_type': 1}, 32: {'from_atom_index': 14, 'to_atom_index': 31, 'bond_type': 1}, 33: {'from_atom_index': 15, 'to_atom_index': 17, 'bond_type': 2}, 34: {'from_atom_index': 15, 'to_atom_index': 32, 'bond_type': 1}, 35: {'from_atom_index': 16, 'to_atom_index': 20, 'bond_type': 2}, 36: {'from_atom_index': 17, 'to_atom_index': 33, 'bond_type': 1}, 37: {'from_atom_index': 18, 'to_atom_index': 34, 'bond_type': 1}, 38: {'from_atom_index': 18, 'to_atom_index': 35, 'bond_type': 1}, 39: {'from_atom_index': 18, 'to_atom_index': 36, 'bond_type': 1}, 40: {'from_atom_index': 19, 'to_atom_index': 21, 'bond_type': 2}, 41: {'from_atom_index': 19, 'to_atom_index': 37, 'bond_type': 1}, 42: {'from_atom_index': 20, 'to_atom_index': 21, 'bond_type': 1}, 43: {'from_atom_index': 21, 'to_atom_index': 38, 'bond_type': 1}})

    @pytest.fixture
    def morphine_3d_molecule_data(self):
        return ({1: {'element': 'O', 'coords': np.array([-1.993 , -0.474 ,  1.2005])}, 2: {'element': 'O', 'coords': np.array([-2.7826, -2.5168, -0.2218])}, 3: {'element': 'O', 'coords': np.array([-3.622 ,  1.8421,  0.5579])}, 4: {'element': 'N', 'coords': np.array([ 3.1777, -0.0101,  0.4474])}, 5: {'element': 'C', 'coords': np.array([ 0.3699, -0.7149,  0.6616])}, 6: {'element': 'C', 'coords': np.array([ 1.2913, -1.3046, -0.417 ])}, 7: {'element': 'C', 'coords': np.array([ 2.3441, -0.2023, -0.764 ])}, 8: {'element': 'C', 'coords': np.array([-0.9377, -1.475 ,  0.9848])}, 9: {'element': 'C', 'coords': np.array([ 1.1988, -0.3907,  1.9201])}, 10: {'element': 'C', 'coords': np.array([-0.2516,  0.5302,  0.1205])}, 11: {'element': 'C', 'coords': np.array([ 1.6887,  1.1052, -1.3279])}, 12: {'element': 'C', 'coords': np.array([2.4315, 0.4754, 1.6126])}, 13: {'element': 'C', 'coords': np.array([ 0.3384,  1.4306, -0.748 ])}, 14: {'element': 'C', 'coords': np.array([-1.3631, -2.5067, -0.0924])}, 15: {'element': 'C', 'coords': np.array([ 0.5066, -1.8183, -1.5971])}, 16: {'element': 'C', 'coords': np.array([-1.5672,  0.6306,  0.5136])}, 17: {'element': 'C', 'coords': np.array([-0.7155, -2.3492, -1.4425])}, 18: {'element': 'C', 'coords': np.array([4.3733, 0.7916, 0.2084])}, 19: {'element': 'C', 'coords': np.array([-0.4184,  2.5415, -1.1246])}, 20: {'element': 'C', 'coords': np.array([-2.331 ,  1.7217,  0.162 ])}, 21: {'element': 'C', 'coords': np.array([-1.7382,  2.6936, -0.6541])}, 22: {'element': 'H', 'coords': np.array([ 1.8278, -2.1759, -0.0118])}, 23: {'element': 'H', 'coords': np.array([ 3.0029, -0.6035, -1.5465])}, 24: {'element': 'H', 'coords': np.array([-0.8451, -2.0128,  1.9373])}, 25: {'element': 'H', 'coords': np.array([ 1.5366, -1.3335,  2.3712])}, 26: {'element': 'H', 'coords': np.array([0.5899, 0.1174, 2.679 ])}, 27: {'element': 'H', 'coords': np.array([ 1.5474,  0.9596, -2.4075])}, 28: {'element': 'H', 'coords': np.array([ 2.353 ,  1.968 , -1.2194])}, 29: {'element': 'H', 'coords': np.array([2.1271, 1.5205, 1.476 ])}, 30: {'element': 'H', 'coords': np.array([3.0801, 0.4584, 2.4975])}, 31: {'element': 'H', 'coords': np.array([-1.0772, -3.5067,  0.2593])}, 32: {'element': 'H', 'coords': np.array([ 0.9601, -1.7947, -2.5831])}, 33: {'element': 'H', 'coords': np.array([-1.23  , -2.7505, -2.3109])}, 34: {'element': 'H', 'coords': np.array([4.15  , 1.8479, 0.0287])}, 35: {'element': 'H', 'coords': np.array([ 4.938 ,  0.4055, -0.6472])}, 36: {'element': 'H', 'coords': np.array([5.0444, 0.7352, 1.073 ])}, 37: {'element': 'H', 'coords': np.array([-0.0062,  3.2824, -1.8043])}, 38: {'element': 'H', 'coords': np.array([-2.3121,  3.5638, -0.9645])}, 39: {'element': 'H', 'coords': np.array([-3.1557, -2.6446,  0.6672])}, 40: {'element': 'H', 'coords': np.array([-3.8483,  1.0686,  1.1031])}}, {0: {'from_atom_index': 1, 'to_atom_index': 8, 'bond_type': 1}, 1: {'from_atom_index': 1, 'to_atom_index': 16, 'bond_type': 1}, 2: {'from_atom_index': 2, 'to_atom_index': 14, 'bond_type': 1}, 3: {'from_atom_index': 2, 'to_atom_index': 39, 'bond_type': 1}, 4: {'from_atom_index': 3, 'to_atom_index': 20, 'bond_type': 1}, 5: {'from_atom_index': 3, 'to_atom_index': 40, 'bond_type': 1}, 6: {'from_atom_index': 4, 'to_atom_index': 7, 'bond_type': 1}, 7: {'from_atom_index': 4, 'to_atom_index': 12, 'bond_type': 1}, 8: {'from_atom_index': 4, 'to_atom_index': 18, 'bond_type': 1}, 9: {'from_atom_index': 5, 'to_atom_index': 6, 'bond_type': 1}, 10: {'from_atom_index': 5, 'to_atom_index': 8, 'bond_type': 1}, 11: {'from_atom_index': 5, 'to_atom_index': 9, 'bond_type': 1}, 12: {'from_atom_index': 5, 'to_atom_index': 10, 'bond_type': 1}, 13: {'from_atom_index': 6, 'to_atom_index': 7, 'bond_type': 1}, 14: {'from_atom_index': 6, 'to_atom_index': 15, 'bond_type': 1}, 15: {'from_atom_index': 6, 'to_atom_index': 22, 'bond_type': 1}, 16: {'from_atom_index': 7, 'to_atom_index': 11, 'bond_type': 1}, 17: {'from_atom_index': 7, 'to_atom_index': 23, 'bond_type': 1}, 18: {'from_atom_index': 8, 'to_atom_index': 14, 'bond_type': 1}, 19: {'from_atom_index': 8, 'to_atom_index': 24, 'bond_type': 1}, 20: {'from_atom_index': 9, 'to_atom_index': 12, 'bond_type': 1}, 21: {'from_atom_index': 9, 'to_atom_index': 25, 'bond_type': 1}, 22: {'from_atom_index': 9, 'to_atom_index': 26, 'bond_type': 1}, 23: {'from_atom_index': 10, 'to_atom_index': 13, 'bond_type': 2}, 24: {'from_atom_index': 10, 'to_atom_index': 16, 'bond_type': 1}, 25: {'from_atom_index': 11, 'to_atom_index': 13, 'bond_type': 1}, 26: {'from_atom_index': 11, 'to_atom_index': 27, 'bond_type': 1}, 27: {'from_atom_index': 11, 'to_atom_index': 28, 'bond_type': 1}, 28: {'from_atom_index': 12, 'to_atom_index': 29, 'bond_type': 1}, 29: {'from_atom_index': 12, 'to_atom_index': 30, 'bond_type': 1}, 30: {'from_atom_index': 13, 'to_atom_index': 19, 'bond_type': 1}, 31: {'from_atom_index': 14, 'to_atom_index': 17, 'bond_type': 1}, 32: {'from_atom_index': 14, 'to_atom_index': 31, 'bond_type': 1}, 33: {'from_atom_index': 15, 'to_atom_index': 17, 'bond_type': 2}, 34: {'from_atom_index': 15, 'to_atom_index': 32, 'bond_type': 1}, 35: {'from_atom_index': 16, 'to_atom_index': 20, 'bond_type': 2}, 36: {'from_atom_index': 17, 'to_atom_index': 33, 'bond_type': 1}, 37: {'from_atom_index': 18, 'to_atom_index': 34, 'bond_type': 1}, 38: {'from_atom_index': 18, 'to_atom_index': 35, 'bond_type': 1}, 39: {'from_atom_index': 18, 'to_atom_index': 36, 'bond_type': 1}, 40: {'from_atom_index': 19, 'to_atom_index': 21, 'bond_type': 2}, 41: {'from_atom_index': 19, 'to_atom_index': 37, 'bond_type': 1}, 42: {'from_atom_index': 20, 'to_atom_index': 21, 'bond_type': 1}, 43: {'from_atom_index': 21, 'to_atom_index': 38, 'bond_type': 1}})

    @pytest.fixture
    def heme_2d_molecule_data(self):
        return ({1: {'element': 'Fe', 'coords': np.array([6.7437, 0.7222, 0.    ])}, 2: {'element': 'O', 'coords': np.array([ 7.6407, -5.2892,  0.    ])}, 3: {'element': 'O', 'coords': np.array([13.2337,  0.2017,  0.    ])}, 4: {'element': 'O', 'coords': np.array([ 9.0357, -4.2626,  0.    ])}, 5: {'element': 'O', 'coords': np.array([12.191 , -1.1813,  0.    ])}, 6: {'element': 'N', 'coords': np.array([ 6.7568, -0.2777,  0.    ])}, 7: {'element': 'N', 'coords': np.array([8.2586, 1.0918, 0.    ])}, 8: {'element': 'N', 'coords': np.array([5.2534, 1.0918, 0.    ])}, 9: {'element': 'N', 'coords': np.array([6.7233, 2.4613, 0.    ])}, 10: {'element': 'C', 'coords': np.array([ 7.2574, -1.8464,  0.    ])}, 11: {'element': 'C', 'coords': np.array([9.7955, 0.6247, 0.    ])}, 12: {'element': 'C', 'coords': np.array([ 7.5588, -0.8787,  0.    ])}, 13: {'element': 'C', 'coords': np.array([8.8596, 0.3568, 0.    ])}, 14: {'element': 'C', 'coords': np.array([ 6.2562, -1.8464,  0.    ])}, 15: {'element': 'C', 'coords': np.array([9.7955, 1.6259, 0.    ])}, 16: {'element': 'C', 'coords': np.array([ 7.8502, -2.6518,  0.    ])}, 17: {'element': 'C', 'coords': np.array([10.594 ,  0.0227,  0.    ])}, 18: {'element': 'C', 'coords': np.array([ 5.9549, -0.9122,  0.    ])}, 19: {'element': 'C', 'coords': np.array([8.8261, 1.8938, 0.    ])}, 20: {'element': 'C', 'coords': np.array([ 8.5599, -0.6109,  0.    ])}, 21: {'element': 'C', 'coords': np.array([ 4.9872, -0.6109,  0.    ])}, 22: {'element': 'C', 'coords': np.array([8.5265, 2.828 , 0.    ])}, 23: {'element': 'C', 'coords': np.array([ 7.4491, -3.5678,  0.    ])}, 24: {'element': 'C', 'coords': np.array([11.5146,  0.4132,  0.    ])}, 25: {'element': 'C', 'coords': np.array([4.6858, 0.3233, 0.    ])}, 26: {'element': 'C', 'coords': np.array([7.5588, 3.1293, 0.    ])}, 27: {'element': 'C', 'coords': np.array([ 5.5855, -2.5881,  0.    ])}, 28: {'element': 'C', 'coords': np.array([10.5912,  2.2315,  0.    ])}, 29: {'element': 'C', 'coords': np.array([3.7182, 0.5912, 0.    ])}, 30: {'element': 'C', 'coords': np.array([7.2239, 4.0635, 0.    ])}, 31: {'element': 'C', 'coords': np.array([5.9214, 3.0958, 0.    ])}, 32: {'element': 'C', 'coords': np.array([6.2228, 4.0635, 0.    ])}, 33: {'element': 'C', 'coords': np.array([4.6858, 1.8603, 0.    ])}, 34: {'element': 'C', 'coords': np.array([3.7182, 1.5924, 0.    ])}, 35: {'element': 'C', 'coords': np.array([4.9537, 2.828 , 0.    ])}, 36: {'element': 'C', 'coords': np.array([2.8521, 0.0912, 0.    ])}, 37: {'element': 'C', 'coords': np.array([5.63  , 4.8689, 0.    ])}, 38: {'element': 'C', 'coords': np.array([ 8.0418, -4.3732,  0.    ])}, 39: {'element': 'C', 'coords': np.array([12.3131, -0.1888,  0.    ])}, 40: {'element': 'C', 'coords': np.array([7.7995, 4.8812, 0.    ])}, 41: {'element': 'C', 'coords': np.array([2.9223, 2.1979, 0.    ])}, 42: {'element': 'C', 'coords': np.array([7.3791, 5.7886, 0.    ])}, 43: {'element': 'C', 'coords': np.array([2.    , 1.8114, 0.    ])}, 44: {'element': 'H', 'coords': np.array([ 8.3663, -2.9953,  0.    ])}, 45: {'element': 'H', 'coords': np.array([ 8.2781, -2.2032,  0.    ])}, 46: {'element': 'H', 'coords': np.array([10.1405, -0.4   ,  0.    ])}, 47: {'element': 'H', 'coords': np.array([10.9316, -0.4974,  0.    ])}, 48: {'element': 'H', 'coords': np.array([ 8.9897, -1.0577,  0.    ])}, 49: {'element': 'H', 'coords': np.array([ 4.551 , -1.0515,  0.    ])}, 50: {'element': 'H', 'coords': np.array([8.963 , 3.2682, 0.    ])}, 51: {'element': 'H', 'coords': np.array([ 6.9329, -3.2243,  0.    ])}, 52: {'element': 'H', 'coords': np.array([ 7.0211, -4.0165,  0.    ])}, 53: {'element': 'H', 'coords': np.array([11.9681,  0.8359,  0.    ])}, 54: {'element': 'H', 'coords': np.array([11.177 ,  0.9333,  0.    ])}, 55: {'element': 'H', 'coords': np.array([ 5.1257, -2.1723,  0.    ])}, 56: {'element': 'H', 'coords': np.array([ 5.1697, -3.048 ,  0.    ])}, 57: {'element': 'H', 'coords': np.array([ 6.0454, -3.004 ,  0.    ])}, 58: {'element': 'H', 'coords': np.array([10.9667,  1.7382,  0.    ])}, 59: {'element': 'H', 'coords': np.array([11.0846,  2.607 ,  0.    ])}, 60: {'element': 'H', 'coords': np.array([10.2157,  2.7249,  0.    ])}, 61: {'element': 'H', 'coords': np.array([4.5153, 3.2664, 0.    ])}, 62: {'element': 'H', 'coords': np.array([2.5421, 0.6281, 0.    ])}, 63: {'element': 'H', 'coords': np.array([ 2.3152, -0.2188,  0.    ])}, 64: {'element': 'H', 'coords': np.array([ 3.1622, -0.4457,  0.    ])}, 65: {'element': 'H', 'coords': np.array([6.1293, 5.2364, 0.    ])}, 66: {'element': 'H', 'coords': np.array([5.2625, 5.3682, 0.    ])}, 67: {'element': 'H', 'coords': np.array([5.1307, 4.5014, 0.    ])}, 68: {'element': 'H', 'coords': np.array([8.417 , 4.8257, 0.    ])}, 69: {'element': 'H', 'coords': np.array([3.0007, 2.8129, 0.    ])}, 70: {'element': 'H', 'coords': np.array([7.736 , 6.2956, 0.    ])}, 71: {'element': 'H', 'coords': np.array([6.7616, 5.8441, 0.    ])}, 72: {'element': 'H', 'coords': np.array([1.5066, 2.1868, 0.    ])}, 73: {'element': 'H', 'coords': np.array([1.9216, 1.1963, 0.    ])}, 74: {'element': 'H', 'coords': np.array([ 8.0082, -5.7886,  0.    ])}, 75: {'element': 'H', 'coords': np.array([13.7288, -0.1715,  0.    ])}}, {0: {'from_atom_index': 2, 'to_atom_index': 38, 'bond_type': 1}, 1: {'from_atom_index': 2, 'to_atom_index': 74, 'bond_type': 1}, 2: {'from_atom_index': 3, 'to_atom_index': 39, 'bond_type': 1}, 3: {'from_atom_index': 3, 'to_atom_index': 75, 'bond_type': 1}, 4: {'from_atom_index': 4, 'to_atom_index': 38, 'bond_type': 2}, 5: {'from_atom_index': 5, 'to_atom_index': 39, 'bond_type': 2}, 6: {'from_atom_index': 6, 'to_atom_index': 12, 'bond_type': 1}, 7: {'from_atom_index': 6, 'to_atom_index': 18, 'bond_type': 1}, 8: {'from_atom_index': 7, 'to_atom_index': 13, 'bond_type': 1}, 9: {'from_atom_index': 7, 'to_atom_index': 19, 'bond_type': 1}, 10: {'from_atom_index': 8, 'to_atom_index': 25, 'bond_type': 2}, 11: {'from_atom_index': 8, 'to_atom_index': 33, 'bond_type': 1}, 12: {'from_atom_index': 9, 'to_atom_index': 26, 'bond_type': 1}, 13: {'from_atom_index': 9, 'to_atom_index': 31, 'bond_type': 2}, 14: {'from_atom_index': 10, 'to_atom_index': 12, 'bond_type': 1}, 15: {'from_atom_index': 10, 'to_atom_index': 14, 'bond_type': 2}, 16: {'from_atom_index': 10, 'to_atom_index': 16, 'bond_type': 1}, 17: {'from_atom_index': 11, 'to_atom_index': 13, 'bond_type': 2}, 18: {'from_atom_index': 11, 'to_atom_index': 15, 'bond_type': 1}, 19: {'from_atom_index': 11, 'to_atom_index': 17, 'bond_type': 1}, 20: {'from_atom_index': 12, 'to_atom_index': 20, 'bond_type': 2}, 21: {'from_atom_index': 13, 'to_atom_index': 20, 'bond_type': 1}, 22: {'from_atom_index': 14, 'to_atom_index': 18, 'bond_type': 1}, 23: {'from_atom_index': 14, 'to_atom_index': 27, 'bond_type': 1}, 24: {'from_atom_index': 15, 'to_atom_index': 19, 'bond_type': 2}, 25: {'from_atom_index': 15, 'to_atom_index': 28, 'bond_type': 1}, 26: {'from_atom_index': 16, 'to_atom_index': 23, 'bond_type': 1}, 27: {'from_atom_index': 16, 'to_atom_index': 44, 'bond_type': 1}, 28: {'from_atom_index': 16, 'to_atom_index': 45, 'bond_type': 1}, 29: {'from_atom_index': 17, 'to_atom_index': 24, 'bond_type': 1}, 30: {'from_atom_index': 17, 'to_atom_index': 46, 'bond_type': 1}, 31: {'from_atom_index': 17, 'to_atom_index': 47, 'bond_type': 1}, 32: {'from_atom_index': 18, 'to_atom_index': 21, 'bond_type': 2}, 33: {'from_atom_index': 19, 'to_atom_index': 22, 'bond_type': 1}, 34: {'from_atom_index': 20, 'to_atom_index': 48, 'bond_type': 1}, 35: {'from_atom_index': 21, 'to_atom_index': 25, 'bond_type': 1}, 36: {'from_atom_index': 21, 'to_atom_index': 49, 'bond_type': 1}, 37: {'from_atom_index': 22, 'to_atom_index': 26, 'bond_type': 2}, 38: {'from_atom_index': 22, 'to_atom_index': 50, 'bond_type': 1}, 39: {'from_atom_index': 23, 'to_atom_index': 38, 'bond_type': 1}, 40: {'from_atom_index': 23, 'to_atom_index': 51, 'bond_type': 1}, 41: {'from_atom_index': 23, 'to_atom_index': 52, 'bond_type': 1}, 42: {'from_atom_index': 24, 'to_atom_index': 39, 'bond_type': 1}, 43: {'from_atom_index': 24, 'to_atom_index': 53, 'bond_type': 1}, 44: {'from_atom_index': 24, 'to_atom_index': 54, 'bond_type': 1}, 45: {'from_atom_index': 25, 'to_atom_index': 29, 'bond_type': 1}, 46: {'from_atom_index': 26, 'to_atom_index': 30, 'bond_type': 1}, 47: {'from_atom_index': 27, 'to_atom_index': 55, 'bond_type': 1}, 48: {'from_atom_index': 27, 'to_atom_index': 56, 'bond_type': 1}, 49: {'from_atom_index': 27, 'to_atom_index': 57, 'bond_type': 1}, 50: {'from_atom_index': 28, 'to_atom_index': 58, 'bond_type': 1}, 51: {'from_atom_index': 28, 'to_atom_index': 59, 'bond_type': 1}, 52: {'from_atom_index': 28, 'to_atom_index': 60, 'bond_type': 1}, 53: {'from_atom_index': 29, 'to_atom_index': 34, 'bond_type': 2}, 54: {'from_atom_index': 29, 'to_atom_index': 36, 'bond_type': 1}, 55: {'from_atom_index': 30, 'to_atom_index': 32, 'bond_type': 2}, 56: {'from_atom_index': 30, 'to_atom_index': 40, 'bond_type': 1}, 57: {'from_atom_index': 31, 'to_atom_index': 32, 'bond_type': 1}, 58: {'from_atom_index': 31, 'to_atom_index': 35, 'bond_type': 1}, 59: {'from_atom_index': 32, 'to_atom_index': 37, 'bond_type': 1}, 60: {'from_atom_index': 33, 'to_atom_index': 34, 'bond_type': 1}, 61: {'from_atom_index': 33, 'to_atom_index': 35, 'bond_type': 2}, 62: {'from_atom_index': 34, 'to_atom_index': 41, 'bond_type': 1}, 63: {'from_atom_index': 35, 'to_atom_index': 61, 'bond_type': 1}, 64: {'from_atom_index': 36, 'to_atom_index': 62, 'bond_type': 1}, 65: {'from_atom_index': 36, 'to_atom_index': 63, 'bond_type': 1}, 66: {'from_atom_index': 36, 'to_atom_index': 64, 'bond_type': 1}, 67: {'from_atom_index': 37, 'to_atom_index': 65, 'bond_type': 1}, 68: {'from_atom_index': 37, 'to_atom_index': 66, 'bond_type': 1}, 69: {'from_atom_index': 37, 'to_atom_index': 67, 'bond_type': 1}, 70: {'from_atom_index': 40, 'to_atom_index': 42, 'bond_type': 2}, 71: {'from_atom_index': 40, 'to_atom_index': 68, 'bond_type': 1}, 72: {'from_atom_index': 41, 'to_atom_index': 43, 'bond_type': 2}, 73: {'from_atom_index': 41, 'to_atom_index': 69, 'bond_type': 1}, 74: {'from_atom_index': 42, 'to_atom_index': 70, 'bond_type': 1}, 75: {'from_atom_index': 42, 'to_atom_index': 71, 'bond_type': 1}, 76: {'from_atom_index': 43, 'to_atom_index': 72, 'bond_type': 1}, 77: {'from_atom_index': 43, 'to_atom_index': 73, 'bond_type': 1}})

    @pytest.fixture
    def heme_3d_molecule_data(self):
        return ({1: {'element': 'O', 'coords': np.array([ 7.1385,  2.705 , -0.6711])}, 2: {'element': 'O', 'coords': np.array([ 5.7615, -3.2503, -2.9408])}, 3: {'element': 'O', 'coords': np.array([6.7154, 2.1599, 1.493 ])}, 4: {'element': 'O', 'coords': np.array([ 6.1372, -3.4886, -0.7132])}, 5: {'element': 'N', 'coords': np.array([-2.525 ,  1.9272,  0.2862])}, 6: {'element': 'N', 'coords': np.array([-2.6939, -1.118 ,  0.2758])}, 7: {'element': 'N', 'coords': np.array([0.4051, 1.517 , 0.2379])}, 8: {'element': 'N', 'coords': np.array([ 0.1811, -1.3404,  0.4974])}, 9: {'element': 'C', 'coords': np.array([2.507 , 2.3377, 0.8711])}, 10: {'element': 'C', 'coords': np.array([ 2.0591, -2.6167,  0.1996])}, 11: {'element': 'C', 'coords': np.array([1.6482, 1.2058, 0.4657])}, 12: {'element': 'C', 'coords': np.array([1.6304, 3.3517, 0.8618])}, 13: {'element': 'C', 'coords': np.array([ 1.5429, -1.2639,  0.3342])}, 14: {'element': 'C', 'coords': np.array([ 1.0549, -3.502 ,  0.2769])}, 15: {'element': 'C', 'coords': np.array([0.3143, 2.872 , 0.4652])}, 16: {'element': 'C', 'coords': np.array([-0.1068, -2.6087,  0.4631])}, 17: {'element': 'C', 'coords': np.array([-2.0505,  3.1577, -0.111 ])}, 18: {'element': 'C', 'coords': np.array([-3.9963, -0.6924,  0.2747])}, 19: {'element': 'C', 'coords': np.array([-2.5688, -2.4592,  0.54  ])}, 20: {'element': 'C', 'coords': np.array([-3.7828,  1.7074, -0.2302])}, 21: {'element': 'C', 'coords': np.array([3.9475, 2.2748, 1.2062])}, 22: {'element': 'C', 'coords': np.array([ 3.5095, -2.9072,  0.0057])}, 23: {'element': 'C', 'coords': np.array([ 2.2658, -0.1348,  0.3202])}, 24: {'element': 'C', 'coords': np.array([-3.0486,  3.753 , -0.8571])}, 25: {'element': 'C', 'coords': np.array([-4.7892, -1.9053,  0.5602])}, 26: {'element': 'C', 'coords': np.array([-4.1304,  2.8451, -0.9341])}, 27: {'element': 'C', 'coords': np.array([-3.9471, -2.9601,  0.7181])}, 28: {'element': 'C', 'coords': np.array([-0.7823,  3.6329,  0.3107])}, 29: {'element': 'C', 'coords': np.array([-1.4551, -3.2035,  0.6248])}, 30: {'element': 'C', 'coords': np.array([-4.5176,  0.5263,  0.0526])}, 31: {'element': 'C', 'coords': np.array([1.9005, 4.7807, 1.1965])}, 32: {'element': 'C', 'coords': np.array([4.8520e+00, 2.5394e+00, 3.3000e-03])}, 33: {'element': 'C', 'coords': np.array([ 3.9112, -2.9257, -1.4638])}, 34: {'element': 'C', 'coords': np.array([ 1.0259, -4.9791,  0.1919])}, 35: {'element': 'C', 'coords': np.array([-2.9926,  5.1012, -1.4661])}, 36: {'element': 'C', 'coords': np.array([-6.2814, -1.8735,  0.6439])}, 37: {'element': 'C', 'coords': np.array([-5.36  ,  3.0491, -1.6044])}, 38: {'element': 'C', 'coords': np.array([-4.3596, -4.3097,  1.0073])}, 39: {'element': 'C', 'coords': np.array([6.3128, 2.4348, 0.3698])}, 40: {'element': 'C', 'coords': np.array([ 5.3729, -3.2588, -1.6419])}, 41: {'element': 'C', 'coords': np.array([-6.1715,  2.1311, -2.1847])}, 42: {'element': 'C', 'coords': np.array([-4.6339, -5.2115,  0.0645])}, 43: {'element': 'H', 'coords': np.array([4.1938, 1.3129, 1.6711])}, 44: {'element': 'H', 'coords': np.array([4.1687, 3.0159, 1.9856])}, 45: {'element': 'H', 'coords': np.array([ 3.7406, -3.8863,  0.4471])}, 46: {'element': 'H', 'coords': np.array([ 4.1341, -2.2066,  0.5729])}, 47: {'element': 'H', 'coords': np.array([ 3.3403, -0.1671,  0.1855])}, 48: {'element': 'H', 'coords': np.array([-0.7083,  4.7057,  0.4708])}, 49: {'element': 'H', 'coords': np.array([-1.5138, -4.2667,  0.8304])}, 50: {'element': 'H', 'coords': np.array([-2.0287,  1.2921,  0.8961])}, 51: {'element': 'H', 'coords': np.array([-1.9035, -0.5315,  0.0596])}, 52: {'element': 'H', 'coords': np.array([-5.5979,  0.6383,  0.092 ])}, 53: {'element': 'H', 'coords': np.array([1.2897, 5.1008, 2.0471])}, 54: {'element': 'H', 'coords': np.array([2.9482, 4.9486, 1.4639])}, 55: {'element': 'H', 'coords': np.array([1.6775, 5.4274, 0.3414])}, 56: {'element': 'H', 'coords': np.array([ 4.6712,  3.5474, -0.3875])}, 57: {'element': 'H', 'coords': np.array([ 4.6518,  1.8113, -0.7907])}, 58: {'element': 'H', 'coords': np.array([ 3.3272, -3.6772, -2.0076])}, 59: {'element': 'H', 'coords': np.array([ 3.7327, -1.9441, -1.9173])}, 60: {'element': 'H', 'coords': np.array([ 2.0137, -5.3942, -0.029 ])}, 61: {'element': 'H', 'coords': np.array([ 0.3499, -5.3061, -0.6044])}, 62: {'element': 'H', 'coords': np.array([ 0.6873, -5.4128,  1.1379])}, 63: {'element': 'H', 'coords': np.array([-3.5447,  5.8188, -0.8503])}, 64: {'element': 'H', 'coords': np.array([-3.4318,  5.0997, -2.4692])}, 65: {'element': 'H', 'coords': np.array([-1.9644,  5.4627, -1.568 ])}, 66: {'element': 'H', 'coords': np.array([-6.7151, -1.5506, -0.3082])}, 67: {'element': 'H', 'coords': np.array([-6.61  , -1.1876,  1.4317])}, 68: {'element': 'H', 'coords': np.array([-6.7014, -2.8571,  0.8758])}, 69: {'element': 'H', 'coords': np.array([-5.693 ,  4.0826, -1.6921])}, 70: {'element': 'H', 'coords': np.array([-4.4411, -4.5822,  2.0553])}, 71: {'element': 'H', 'coords': np.array([-7.0854,  2.4544, -2.6733])}, 72: {'element': 'H', 'coords': np.array([-5.9398,  1.0737, -2.2183])}, 73: {'element': 'H', 'coords': np.array([-4.9394, -6.2155,  0.3391])}, 74: {'element': 'H', 'coords': np.array([-4.5621, -4.9765, -0.9923])}, 75: {'element': 'H', 'coords': np.array([ 8.0834,  2.6451, -0.4143])}, 76: {'element': 'H', 'coords': np.array([ 6.7157, -3.456 , -3.0389])}}, {0: {'from_atom_index': 1, 'to_atom_index': 39, 'bond_type': 1}, 1: {'from_atom_index': 1, 'to_atom_index': 75, 'bond_type': 1}, 2: {'from_atom_index': 2, 'to_atom_index': 40, 'bond_type': 1}, 3: {'from_atom_index': 2, 'to_atom_index': 76, 'bond_type': 1}, 4: {'from_atom_index': 3, 'to_atom_index': 39, 'bond_type': 2}, 5: {'from_atom_index': 4, 'to_atom_index': 40, 'bond_type': 2}, 6: {'from_atom_index': 5, 'to_atom_index': 17, 'bond_type': 1}, 7: {'from_atom_index': 5, 'to_atom_index': 20, 'bond_type': 1}, 8: {'from_atom_index': 5, 'to_atom_index': 50, 'bond_type': 1}, 9: {'from_atom_index': 6, 'to_atom_index': 18, 'bond_type': 1}, 10: {'from_atom_index': 6, 'to_atom_index': 19, 'bond_type': 1}, 11: {'from_atom_index': 6, 'to_atom_index': 51, 'bond_type': 1}, 12: {'from_atom_index': 7, 'to_atom_index': 11, 'bond_type': 2}, 13: {'from_atom_index': 7, 'to_atom_index': 15, 'bond_type': 1}, 14: {'from_atom_index': 8, 'to_atom_index': 13, 'bond_type': 1}, 15: {'from_atom_index': 8, 'to_atom_index': 16, 'bond_type': 2}, 16: {'from_atom_index': 9, 'to_atom_index': 11, 'bond_type': 1}, 17: {'from_atom_index': 9, 'to_atom_index': 12, 'bond_type': 2}, 18: {'from_atom_index': 9, 'to_atom_index': 21, 'bond_type': 1}, 19: {'from_atom_index': 10, 'to_atom_index': 13, 'bond_type': 1}, 20: {'from_atom_index': 10, 'to_atom_index': 14, 'bond_type': 2}, 21: {'from_atom_index': 10, 'to_atom_index': 22, 'bond_type': 1}, 22: {'from_atom_index': 11, 'to_atom_index': 23, 'bond_type': 1}, 23: {'from_atom_index': 12, 'to_atom_index': 15, 'bond_type': 1}, 24: {'from_atom_index': 12, 'to_atom_index': 31, 'bond_type': 1}, 25: {'from_atom_index': 13, 'to_atom_index': 23, 'bond_type': 2}, 26: {'from_atom_index': 14, 'to_atom_index': 16, 'bond_type': 1}, 27: {'from_atom_index': 14, 'to_atom_index': 34, 'bond_type': 1}, 28: {'from_atom_index': 15, 'to_atom_index': 28, 'bond_type': 2}, 29: {'from_atom_index': 16, 'to_atom_index': 29, 'bond_type': 1}, 30: {'from_atom_index': 17, 'to_atom_index': 24, 'bond_type': 2}, 31: {'from_atom_index': 17, 'to_atom_index': 28, 'bond_type': 1}, 32: {'from_atom_index': 18, 'to_atom_index': 25, 'bond_type': 1}, 33: {'from_atom_index': 18, 'to_atom_index': 30, 'bond_type': 2}, 34: {'from_atom_index': 19, 'to_atom_index': 27, 'bond_type': 1}, 35: {'from_atom_index': 19, 'to_atom_index': 29, 'bond_type': 2}, 36: {'from_atom_index': 20, 'to_atom_index': 26, 'bond_type': 2}, 37: {'from_atom_index': 20, 'to_atom_index': 30, 'bond_type': 1}, 38: {'from_atom_index': 21, 'to_atom_index': 32, 'bond_type': 1}, 39: {'from_atom_index': 21, 'to_atom_index': 43, 'bond_type': 1}, 40: {'from_atom_index': 21, 'to_atom_index': 44, 'bond_type': 1}, 41: {'from_atom_index': 22, 'to_atom_index': 33, 'bond_type': 1}, 42: {'from_atom_index': 22, 'to_atom_index': 45, 'bond_type': 1}, 43: {'from_atom_index': 22, 'to_atom_index': 46, 'bond_type': 1}, 44: {'from_atom_index': 23, 'to_atom_index': 47, 'bond_type': 1}, 45: {'from_atom_index': 24, 'to_atom_index': 26, 'bond_type': 1}, 46: {'from_atom_index': 24, 'to_atom_index': 35, 'bond_type': 1}, 47: {'from_atom_index': 25, 'to_atom_index': 27, 'bond_type': 2}, 48: {'from_atom_index': 25, 'to_atom_index': 36, 'bond_type': 1}, 49: {'from_atom_index': 26, 'to_atom_index': 37, 'bond_type': 1}, 50: {'from_atom_index': 27, 'to_atom_index': 38, 'bond_type': 1}, 51: {'from_atom_index': 28, 'to_atom_index': 48, 'bond_type': 1}, 52: {'from_atom_index': 29, 'to_atom_index': 49, 'bond_type': 1}, 53: {'from_atom_index': 30, 'to_atom_index': 52, 'bond_type': 1}, 54: {'from_atom_index': 31, 'to_atom_index': 53, 'bond_type': 1}, 55: {'from_atom_index': 31, 'to_atom_index': 54, 'bond_type': 1}, 56: {'from_atom_index': 31, 'to_atom_index': 55, 'bond_type': 1}, 57: {'from_atom_index': 32, 'to_atom_index': 39, 'bond_type': 1}, 58: {'from_atom_index': 32, 'to_atom_index': 56, 'bond_type': 1}, 59: {'from_atom_index': 32, 'to_atom_index': 57, 'bond_type': 1}, 60: {'from_atom_index': 33, 'to_atom_index': 40, 'bond_type': 1}, 61: {'from_atom_index': 33, 'to_atom_index': 58, 'bond_type': 1}, 62: {'from_atom_index': 33, 'to_atom_index': 59, 'bond_type': 1}, 63: {'from_atom_index': 34, 'to_atom_index': 60, 'bond_type': 1}, 64: {'from_atom_index': 34, 'to_atom_index': 61, 'bond_type': 1}, 65: {'from_atom_index': 34, 'to_atom_index': 62, 'bond_type': 1}, 66: {'from_atom_index': 35, 'to_atom_index': 63, 'bond_type': 1}, 67: {'from_atom_index': 35, 'to_atom_index': 64, 'bond_type': 1}, 68: {'from_atom_index': 35, 'to_atom_index': 65, 'bond_type': 1}, 69: {'from_atom_index': 36, 'to_atom_index': 66, 'bond_type': 1}, 70: {'from_atom_index': 36, 'to_atom_index': 67, 'bond_type': 1}, 71: {'from_atom_index': 36, 'to_atom_index': 68, 'bond_type': 1}, 72: {'from_atom_index': 37, 'to_atom_index': 41, 'bond_type': 2}, 73: {'from_atom_index': 37, 'to_atom_index': 69, 'bond_type': 1}, 74: {'from_atom_index': 38, 'to_atom_index': 42, 'bond_type': 2}, 75: {'from_atom_index': 38, 'to_atom_index': 70, 'bond_type': 1}, 76: {'from_atom_index': 41, 'to_atom_index': 71, 'bond_type': 1}, 77: {'from_atom_index': 41, 'to_atom_index': 72, 'bond_type': 1}, 78: {'from_atom_index': 42, 'to_atom_index': 73, 'bond_type': 1}, 79: {'from_atom_index': 42, 'to_atom_index': 74, 'bond_type': 1}})
